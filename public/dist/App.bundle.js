...
var ajaxHeart = function ajaxHeart(e) {
  var _this = this;
...
function loadPlaces(map) {
  ...
  _axios2.default.get('/api/v1/stores/near?lat=' + lat + '&lng=' + lng).then(function (response) {
    ...
    var markers = response.data.map(function (place) {
      ...
      var marker = new google.maps.Marker({ position: { lng: placeLng, lat: placeLat }, map: map });
    ...
    markers.forEach(function (marker) {
      marker.addListener('click', function () {
        var html = '\n        <div class="popup">\n          <a href="/store/' + this.place.slug + '">\n            <img src="/uploads/' + (this.place.photo || 'store.png') + '" alt="image of ' + this.place.name + '" />\n            <p> ' + this.place.name + ' - ' + this.place.location.address + '</p>\n          </a>\n        </div>';
...
function makeMap(mapDiv) {
  ...
  var autocomplete = new google.maps.places.Autocomplete((0, _bling.$)('[name=geolocate]'));
...
var _heartForm = __webpack_require__(11);

var _heartForm2 = _interopRequireDefault(_heartForm);
...
(0, _bling.$$)('form.heart').on('submit', _heartForm2.default);
